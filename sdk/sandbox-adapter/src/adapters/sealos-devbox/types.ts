...
export type DevboxApiResponse<T> = {
  code: number;
  message: string;
  data: T;
};
...
export type DevboxMutationData = {
  name: string;
  namespace?: string;
  state?: string;
  status?: string;
