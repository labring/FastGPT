...
type AccessPreset = {
  ...
  options: Required<
    Pick<
      ...
      | 'allowUserAccountCancellationFinalizing'
      ...
      | 'allowCurrentSessionTeamAccountCancellationFinalizing'
    >
  >;
};
...
> = {
  ...
  selfCancellation: {
    ...
    options: {
      ...
      allowUserAccountCancellationFinalizing: true,
      allowCurrentUserOwnedTeamAccountCancellationPending: true,
      allowCurrentUserOwnedTeamAccountCancellationFinalizing: true,
