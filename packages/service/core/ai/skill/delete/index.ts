...
import { skillDeleteMQService, type AgentSkillDeleteJobData } from '@fastgpt/dal/redis/bullmq';

export type { AgentSkillDeleteJobData } from '@fastgpt/dal/redis/bullmq';
...
export const initAgentSkillDeleteWorker = () => {
  const worker = skillDeleteMQService.getWorker(agentSkillDeleteProcessor);
...
export const addAgentSkillDeleteJob = (data: AgentSkillDeleteJobData) =>
  skillDeleteMQService.addJob(data);
