...
export const env = createEnv({
  server: {
    AGENT_SANDBOX_PROVIDER: z.enum(['opensandbox', 'sealosdevbox']).optional(),
    ...
    AGENT_SANDBOX_ENTRYPOINT: z.string().optional(),
    AGENT_SANDBOX_USE_SERVER_PROXY: BoolSchema.optional(),
