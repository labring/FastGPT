...
export const Prompt_userQuotePromptList: PromptTemplateItem[] = [
  {
    title: i18nT('app:template.standard_template'),
    desc: '',
    value: `使用 <Reference></Reference> 标记中的内容作为你的知识:
...
问题:"""{{question}}"""`
  },
  {
    title: i18nT('app:template.standard_strict'),
    desc: '',
    value: `忘记你已有的知识，仅使用 <Reference></Reference> 标记中的内容作为你的知识:
...
export const Prompt_DocumentQuote = `将 <Reference></Reference> 中的内容作为你的知识:
<Reference>
{{quote}}
</Reference>
`;
