...
// Re-export types from OpenAI namespace since 'openai/resources' is not resolvable
// under moduleResolution: bundler (openai@4.61 does not expose it in package.json exports)
import type OpenAI from 'openai';
...
export namespace ChatCompletionCreateParams {
  export type Function = OpenAI.ChatCompletionCreateParams.Function;
}
export type ChatCompletionCreateParamsNonStreaming = OpenAI.ChatCompletionCreateParamsNonStreaming;
export type ChatCompletionCreateParamsStreaming = OpenAI.ChatCompletionCreateParamsStreaming;
export type CompletionUsage = OpenAI.CompletionUsage;
