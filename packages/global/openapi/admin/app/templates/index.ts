...
export const AdminTemplatePath: OpenAPIPath = {
  '/proApi/admin/app/templates/create': {
    post: {
      summary: '创建应用模板',
  ...
  '/proApi/admin/app/templates/list': {
    get: {
      summary: '获取应用模板列表',
  ...
  '/proApi/admin/app/templates/update': {
    put: {
      summary: '更新应用模板',
  ...
  '/proApi/admin/app/templates/delete': {
    delete: {
      summary: '删除应用模板',
  ...
  '/proApi/admin/app/templates/updateOrder': {
    put: {
      summary: '更新模板排序',
  ...
  '/proApi/admin/app/templates/updateQuickTemplate': {
    put: {
      summary: '设置快捷模板',
