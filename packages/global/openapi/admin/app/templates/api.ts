...
import {
  ...
  SelectedToolItemTypeSchema
} from '../../../../core/app/formEdit/type';
...
const AdminSelectedToolItemSchema = SelectedToolItemTypeSchema.omit({
  // 编辑器运行时展示谓词不会被持久化，也无法表达为 OpenAPI Schema。
...
const AdminSimpleTemplateSchema = AppFormEditFormV1TypeSchema.extend({
  selectedTools: z.array(AdminSelectedToolItemSchema),
...
/* ============================================================================
 * API: 创建应用模板
 * Route: POST /api/proApi/admin/app/templates/create
 * Method: POST
...
/* ============================================================================
 * API: 更新应用模板
 * Route: PUT /api/proApi/admin/app/templates/update
 * Method: PUT
...
/* ============================================================================
 * API: 更新应用模板排序
 * Route: PUT /api/proApi/admin/app/templates/updateOrder
 * Method: PUT
...
/* ============================================================================
 * API: 设置快捷应用模板
 * Route: PUT /api/proApi/admin/app/templates/updateQuickTemplate
 * Method: PUT
