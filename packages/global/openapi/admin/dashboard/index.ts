...
export const DashboardPath: OpenAPIPath = {
  '/proApi/admin/dashboard/getUserStats': {
    get: {
      summary: '获取用户全局统计',
  ...
  '/proApi/admin/dashboard/getAppStats': {
    get: {
      summary: '获取应用全局统计',
  ...
  '/proApi/admin/dashboard/getDatasetStats': {
    get: {
      summary: '获取知识库全局统计',
  ...
  '/proApi/admin/dashboard/getChatFormData': {
    get: {
      summary: '获取对话统计数据',
  ...
  '/proApi/admin/dashboard/getWorkflowQpmRange': {
    get: {
  ...
  '/proApi/admin/dashboard/getCostFormData': {
    post: {
      summary: '获取消费统计数据',
  ...
  '/proApi/admin/dashboard/getPaysFormData': {
    get: {
      summary: '获取支付统计数据',
  ...
  '/proApi/admin/dashboard/getUserFormData': {
    get: {
      summary: '获取用户注册统计数据',
