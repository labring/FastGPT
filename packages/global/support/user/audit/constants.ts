...
export enum AuditEventEnum {
  ...
  // Note: the two collaborator events above are written by the pro/admin
  // handlers (src/pages/api/system/model/collaborator/*), not by the
  // /api/core/ai/model handlers.
}
