...
//import { FOLDER_CAPACITY } from '@fastgpt/global/source/file/constants';
//import { File } from '@fastgpt/global/core/app/type';
...
const SelectUsingWayModal = ({ share, onClose }: { share: OutLinkSchema; onClose: () => void }) => {
  ...
  const { getValues, setValue, register, watch } = useForm({
    defaultValues: {
      ...
      scriptCloseIcon:
        'data:image/svg+xml;base64,'
    }
  });
