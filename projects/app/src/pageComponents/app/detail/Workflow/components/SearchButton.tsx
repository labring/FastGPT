...
import { WorkflowDataContext } from '../../WorkflowComponents/context/workflowInitContext';
...
const SearchButton = (props: ButtonProps) => {
  ...
  const setNodes = useContextSelector(WorkflowDataContext, (state) => state.setNodes);
