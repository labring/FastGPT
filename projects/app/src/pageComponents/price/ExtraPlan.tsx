...
const ExtraPlan = ({
  ...
  const showDataset = mode === 'all' || mode === 'dataset';
  const isDualCardLayout = mode === 'all';
  ...
  return (
    <VStack w={'100%'} alignItems={'center'}>
      <Flex
        display={'flex'}
        w={isDualCardLayout ? ['100%', '986.031px'] : ['100%']}
        maxW={isDualCardLayout ? ['100%', '986.031px'] : '600px'}
        h={isDualCardLayout ? ['auto', '488px'] : 'auto'}
        justifyContent={'center'}
        alignItems={'flex-start'}
        gap={isDualCardLayout ? ['16px', '20px'] : 5}
        flexWrap={['wrap', 'nowrap']}
        mx={isDualCardLayout ? undefined : 'auto'}
      >
        {showPoints && (
          <Box
            position={'relative'}
            ...
            <Button
              ...
              onClick={() => {
                ...
                if (
                  ...
                  extraPointsPackages[selectedPackageIndex]
                ) {
          ...
          >
            ...
            >
              <Flex
                ...
                gap={[2, 3]}
                flex={'1 0 0'}
                pr={[0, isDualCardLayout ? '120px' : '100px']}
              >
              ...
              <Box
                ...
                display={['none', 'block']}
                position={'absolute'}
                top={isDualCardLayout ? '-30px' : '-8px'}
                right={isDualCardLayout ? 0 : '-8px'}
                src={'/imgs/price/extraDatasetIcon.svg'}
                alt=""
                w={isDualCardLayout ? '152px' : '120px'}
                h={isDualCardLayout ? '152px' : '120px'}
                pointerEvents={'none'}
              />
            </Flex>
