      ...
      {detailData && (
        <ModalBody>
          ...
          >
            ...
            <GridItem display={'flex'} borderBottomWidth="1px" borderRightWidth="1px">
              <LogTitle>{t('account_model:channel_status')}</LogTitle>
            ...
            <GridItem display={'flex'} borderBottomWidth="1px" borderRightWidth="1px">
              <LogTitle>{t('account_model:channel_name')}</LogTitle>
              <LogContainer>{detailData?.channelName}</LogContainer>
            </GridItem>
            <GridItem display={'flex'} borderBottomWidth="1px">
              <LogTitle>{t('account_model:model')}</LogTitle>
              <LogContainer>{detailData?.model}</LogContainer>
            </GridItem>
            <GridItem display={'flex'} borderBottomWidth="1px" borderRightWidth="1px">
              <LogTitle>{t('account_model:request_at')}</LogTitle>
              <LogContainer>{detailData?.request_at}</LogContainer>
            </GridItem>
            <GridItem display={'flex'} borderBottomWidth="1px">
              <LogTitle>{t('account_model:duration')}</LogTitle>
              <LogContainer>{detailData?.duration.toFixed(2)}s</LogContainer>
            </GridItem>
            <GridItem display={'flex'} borderBottomWidth="1px" borderRightWidth="1px">
              <LogTitle flex={'0 0 150px'}>{t('account_model:model_ttfb_time')}</LogTitle>
              <LogContainer>
                {detailData.ttfb_milliseconds ? `${detailData.ttfb_milliseconds}ms` : '-'}
              </LogContainer>
            </GridItem>
            <GridItem display={'flex'} borderBottomWidth="1px">
              <LogTitle flex={'0 0 150px'}>{t('account_model:model_tokens')}</LogTitle>
              <LogContainer>
            ...
            {detailData?.retry_times !== undefined && (
              <GridItem display={'flex'} borderBottomWidth="1px" colSpan={2}>
                <LogTitle>{t('account_model:retry_times')}</LogTitle>
