        ...
        <Flex fontSize={'20px'} fontWeight={'medium'} my={6}>
          ...
          <Box color={'primary.600'} ml={2}>
            {t('account_usage:usage_summary', {
              ...
              tokens: formatTokenCount(totalInputTokens + totalOutputTokens)
            })}
          </Box>
        </Flex>
