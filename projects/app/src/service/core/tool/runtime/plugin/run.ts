...
import { getPluginRuntimeById } from '@fastgpt/service/core/tool/controller';
import { authPluginCanUse } from '@fastgpt/service/support/permission/auth/tool';
...
export const dispatchRunPlugin = async (props: RunPluginProps): Promise<RunPluginResponse> => {
  ...
  if (!inputModule) return Promise.reject('Tool error, It has no set input.');
