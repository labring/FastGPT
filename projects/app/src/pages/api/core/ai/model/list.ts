...
async function handler(
  ...
  // Provider options represent the accessible, actually-added inventory. Compute
  // them before applying filters so selecting one does not hide peers.
...
const formatModelListItem = (
  ...
  charsPointsPrice: modelData.isSystem ? modelData.charsPointsPrice : undefined,
  priceTiers: modelData.isSystem ? modelData.priceTiers : undefined,
  // Tag
  contextToken:
