 ...
 * POST /api/core/train/embedding/task/eval-report
 *
 * This API exports an evaluation report comparing embedding performance before and after training.
 *
 * Request Body:
...
async function handler(req: NextApiRequest, res: NextApiResponse) {
  ...
  if (!baseModelEvalResult || !tunedModelEvalResult) {
    return Promise.reject(EmbeddingTrainErrEnum.embeddingEvalResultsNotFound);
  }
