...
function WorkorderButton() {
  ...
  return <>{
    open ?
      <Flex position='fixed' bottom='20%' right='0' height='62px' width='58px'
        zIndex={100}
      ...
      >
        <Box
          zIndex={101} width='14px' height='14px' position='absolute' left='-6px' top='-6px' borderRadius='full' background='white' border='1px' borderColor={'myGray.25'}
          bgColor='myGray.25'
          _hover={{
            cursor: 'pointer',
            bgColor: 'myGray.100',
      ...
      : <Flex position='fixed' bottom='20%' right='0' height='44px' width='19px'
        bgColor='myGray.25'
        borderTopLeftRadius='8px'
        borderBottomLeftRadius='8px'
        border={'1px'}
