 ...
 * - /admin/license：管理员主页，License 激活入口
 * - /admin/resources/model：模型提供商，未配置模型时对话与知识库不可用
 * - /admin/resources/tool：系统工具，插件与工具接入配置
 * - /admin/migration：版本升级，跑的是 app 自带的迁移脚本（projects/app/src/migration），
