            ...
            <Box>
              <Box
                ...
                dangerouslySetInnerHTML={{
                  __html:
                    value +
                    `<mark style="background-color: #FEF0C7">\n\n${t('common:core.app.QG.Fixed Prompt')}</mark>`
                }}
                onInput={(e) => {
                  const content = e.currentTarget.innerHTML;
                  const newValue = content.replace(/<mark[^>]*>.*?<\/mark>/g, '');
                  setValue(newValue);
                }}
                sx={{
                  '&:focus': {
        ...
        <Flex justify={'flex-end'} gap={3} pb={2} pr={8}>
          ...
          <Button
            ...
            onClick={() => {
              ...
              const cleanValue = content.replace(/<mark[^>]*>.*?<\/mark>/g, '').trim();
              onChange(cleanValue);
              onClose();
            }}
            w={20}
