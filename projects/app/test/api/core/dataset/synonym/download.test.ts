...
const {
  mockConfigLean,
  mockAuthDataset,
  mockAssertDatasetSynonymConfigMigrated,
  mockGetDatasetSynonymMappings
} = vi.hoisted(() => ({
  mockConfigLean: vi.fn(),
  mockAuthDataset: vi.fn(),
  mockAssertDatasetSynonymConfigMigrated: vi.fn(),
...
vi.mock('@fastgpt/service/core/dataset/synonym/entity', () => ({
  assertDatasetSynonymConfigMigrated: mockAssertDatasetSynonymConfigMigrated,
