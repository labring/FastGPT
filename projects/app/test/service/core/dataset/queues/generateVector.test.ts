...
describe('generateVector image embedding helpers', () => {
  ...
  it('uses a newly generated pure-image description without requiring imageDescMap', () => {
    const result = getRebuildUpdateInput({
  ...
  it('keeps image, question and summary indexes generated by the current rebuild', () => {
