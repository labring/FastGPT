...
var allowBaseSyscalls = []int{
	...
	syscall.SYS_FSTATAT, syscall.SYS_FSTAT, syscall.SYS_FCNTL, syscall.SYS_IOCTL,
	syscall.SYS_OPENAT, syscall.SYS_FACCESSAT, syscall.SYS_READLINKAT,
	syscall.SYS_PREAD64, syscall.SYS_LSEEK, syscall.SYS_GETDENTS64,
	...
	syscall.SYS_GETRANDOM, syscall.SYS_EVENTFD2,
...
var errnoSyscalls = []int{
	syscall.SYS_CLONE, sysClone3, syscall.SYS_MKDIRAT,
}
...
var allowNetworkSyscalls = []int{
	...
	syscall.SYS_SENDTO, syscall.SYS_RECVFROM, syscall.SYS_SENDMSG, syscall.SYS_SENDMMSG, syscall.SYS_RECVMSG,
