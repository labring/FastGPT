...
3. The deployment can access AI Platform Marketplace when installing from Marketplace.
...
1. Open **Tools** in the AI Platform workspace.
...
4. Wait for AI Platform to upload and inspect the packages.
