...
![](../../../public/imgs/translate5.png)

![](../../../public/imgs/translate61.png)

可以看到反思翻译后的效果还是好上不少的，其中反思的输出如下

![](../../../public/imgs/translate7.png)
...
![](../../../public/imgs/translate11.png)

### 多文本块反思

![](../../../public/imgs/translate12.png)

### 多文本块提升翻译

![](../../../public/imgs/translate13.png)
...
![](../../../public/imgs/translate14.png)

也就是通过判断当前处理的这个文本块，是否是最后一个文本块，从而判断是否需要继续执行，就这样，我们实现了长文反思翻译的效果

完整工作流如下

![](../../../public/imgs/translate15.png)

## 运行效果

首先输入全局设置

![](../../../public/imgs/translate16.png)

然后输入需要翻译的文本，这里我选择了一章哈利波特的英文原文来做翻译，其文本长度通过 openai 对 tokens 数量的判断如下

![](../../../public/imgs/translate17.png)

实际运行效果如下

![](../../../public/imgs/translate18.png)
...
![](../../../public/imgs/translate19.png)

然后再让我们来看看运行效果

![](../../../public/imgs/translate20.png)

给了和之前相同的一段文本进行测试，测试效果还是比较显著的，就比如红框部分，之前的翻译如下

![](../../../public/imgs/translate21.png)
