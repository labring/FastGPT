---
title: Add Fixed Opening and Closing Content
description: Use Specified Reply modules to add fixed opening and closing messages to responses
---

![](../../../public/imgs/demo-fix-evidence1.jpg)

![](../../../public/imgs/demo-fix-evidence2.jpg)


As shown above, you can use Specified Reply modules to add fixed opening and closing content to your responses.

## Module Configuration

Copy the configuration below, click the import button in the top-right corner of "Advanced Orchestration", and paste it in.
