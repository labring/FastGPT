...
- [Configure Custom Domain](../../introduction/guide/team_permissions/customDomain.en.mdx)
...
![Image](../../../public/imgs/use-cases/external-integration/wecom/4.png)
...
![Image](../../../public/imgs/use-cases/external-integration/wecom/5.png)
...
![Image](../../../public/imgs/use-cases/external-integration/wecom/6.png)

## 3. Use the Intelligent Bot

In the WeCom platform's "Contacts", you can find the created bot and start sending messages

![Image](../../../public/imgs/use-cases/external-integration/wecom/7.png)
