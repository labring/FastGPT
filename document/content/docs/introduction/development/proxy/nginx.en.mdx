...
After filling everything in, click **Deploy** in the top right corner to complete deployment.

## Update FastGPT Environment Variables

1. Go to the deployed app's details and copy the external address.

   > Note: This is an API address — clicking it won't work. To verify, visit: `*.cloud.sealos.io/openai/api`. If you see `Invalid URL (GET /api)`, it's working.
   
   ![](/imgs/sealos7.png)

2. Update the environment variable (FastGPT's environment variable, not Sealos'):
