...
[Upgrade script documentation](./upgrade-intruction/) — read the docs first to determine which version to upgrade to. Do not skip versions.
...
1. Check the [update documentation](./upgrade-intruction/) to confirm the target version — avoid skipping versions.
