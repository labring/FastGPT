...
### (5)Limitations of local deployment

For details, refer to https://fael3z0zfze.feishu.cn/wiki/OFpAw8XzAi36Guk8dfucrCKUnjg.

---

### (6)Can it run purely locally?

Yes. You need to prepare the vector model and LLM model.

---

### (7)Other models cannot perform question classification/content extraction
...
### (9)After enabling content completion, the response speed becomes slow
...
### (10)Normal reply in the page, API error
...
### (11)Knowledge base indexing has no progress/indexing is very slow
