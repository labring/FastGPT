...
description: Use specified reply modules to create fixed opening and closing messages
---
...
Copy the configuration below, click the import button in the top-right corner of "Advanced Workflow", and paste it in.
