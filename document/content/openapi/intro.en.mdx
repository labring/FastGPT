...
AI Platform API documentation is split into two sets:
...
AI Platform OpenAPI endpoints let you authenticate with an API Key to operate related AI Platform services and resources, such as calling app chat endpoints, uploading Dataset data, and running search tests. For compatibility and security reasons, not all endpoints can be accessed with an API Key.
