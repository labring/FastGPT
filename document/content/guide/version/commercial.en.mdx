...
AI Platform Commercial Edition is an enhanced version built on top of the Community Edition with additional exclusive features. Simply install the commercial image and configure the internal network address on your existing Community Edition setup to get started.
...
AI Platform Commercial Edition offers 3 pricing models based on deployment type. Below are the common details for each. If you have further questions,{' '}<CommercialContactDialog
  label="contact us"
...
<Alert icon="🤖" context="success">
  - "6 versions of upgrade support" means the AI Platform team assists with 6 upgrades — not that the
