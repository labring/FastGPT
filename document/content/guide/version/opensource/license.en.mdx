...
The AI Platform project is open-sourced under the Apache License 2.0, with the following additional conditions:

- AI Platform may be used commercially -- for example, as a backend-as-a-service for other apps or as an app development platform for enterprises. However, a commercial license is required when the following conditions apply:
  ...
  - Logo and copyright: You may not remove or modify the logo or copyright information in the AI Platform console.
...
- As a contributor, you agree that your contributed code may be used for the following purposes:
  ...
  - It may be used for commercial purposes, such as AI Platform's cloud service.
