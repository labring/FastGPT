...
Starting from version 4.8.10, AI Platform commercial edition supports direct WeChat Official Account integration without additional APIs.
...
In AI Platform, select the app you want to integrate. On the _Publishing Channels_ page, create a new WeChat Official Account publishing channel and fill in the basic information.
...
1. Randomly generate an AES Key and enter it into the AI Platform configuration dialog.

2. Select the encryption mode as Secure Mode.

## 5. Get URL

1. Confirm creation in AI Platform and get the URL.
...
Now when users send messages to the official account, messages will be forwarded to AI Platform, and conversation results will be returned through the official account.
