...
- 从 4.12.4 版本起，AI Platform 商业版支持直接接入企微机器人，无需额外的 API。

- 从 4.14.4 版本起，AI Platform 云服务版支持通过配置自定义域名的方式接入企微智能机器人。
...
在 AI Platform 中，选择要使用 Agent，在发布渠道页面，选择“企业微信机器人”，点击“创建”
...
3. 查看 AI Platform 对话日志，是否有对应的提问记录。
