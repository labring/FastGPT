...
Pass the identity in the MCP transport headers, not in the tool arguments. AI Platform accepts these headers:
...
The tool list exposes only metadata such as tool names and parameters. AI Platform rechecks team membership and application permission for every tool call.
...
Restart AI Platform after changing the environment variable:
