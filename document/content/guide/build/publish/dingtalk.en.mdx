...
Starting from version 4.8.16, AI Platform commercial edition supports direct DingTalk bot integration without additional APIs.
...
In AI Platform, select the app you want to integrate. On the **Publishing Channels** page, create a new DingTalk bot publishing channel.
...
Click the **Bot** capability on the left sidebar, then set the **Message Receiving Mode** at the bottom to **HTTP Mode**, and paste the AI Platform callback address you copied earlier as the message receiving address.
