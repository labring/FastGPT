...
- Starting from version 4.12.4, AI Platform commercial edition supports direct WeCom bot integration without additional APIs.
- Starting from version 4.14.4, AI Platform cloud service edition supports WeCom intelligent bot integration through custom domain configuration.
...
In AI Platform, select the Agent you want to use. On the Publishing Channels page, select "WeCom Bot" and click "Create"
...
3. Check AI Platform chat logs to see if there is a corresponding question record.
