...
1. Go to the editing page of the **"Agent"** app where you want to integrate this skill (currently, only Agent apps support direct skill binding; simple apps and workflows do not support it).
...
Once bound, the Agent can use this Skill:
