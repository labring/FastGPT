...
When users start a new conversation, they will see the welcome message and quick question buttons. After a user clicks a quick question, AI Platform sends that question as the user's message.
