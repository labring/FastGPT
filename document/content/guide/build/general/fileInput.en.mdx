...
In AI Platform's chat history, messages with role=user store their value in this structure:
...
2. Multimodal recognition: handles media files such as images, audio, and video. AI Platform converts them into model-readable input, and a model with the corresponding capability reads them.
