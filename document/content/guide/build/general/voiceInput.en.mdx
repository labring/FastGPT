...
After Voice Input is enabled, the chat input box shows a voice recording entry. Users can click it to start recording, and AI Platform converts the recording to text after it finishes.
...
When **Auto Send** is enabled, AI Platform automatically sends the recognized text after recording finishes. Users do not need to click the send button manually.
