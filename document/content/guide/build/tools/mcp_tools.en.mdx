...
Starting from AI Platform v4.9.6, a new app type called MCP Toolkit has been added. It lets you provide an MCP SSE URL to batch-create tools that models can easily call. Here's how to create an MCP Toolkit and have AI use its tools.
...
AI Platform also supports calling an entire MCP Toolkit. The AI automatically picks the right tool to run.
