...
AI Platform Cloud supports custom domain configuration starting from v4.14.4.
...
You can now access AI Platform services and call AI Platform APIs using your own domain.
