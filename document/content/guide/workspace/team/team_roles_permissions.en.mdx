...
<table>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>Can View</td>
      <td>
        Can view this file/folder's content. Requires collection permission enabled on the Dataset
      </td>
    </tr>
    <tr>
      <td>Can Edit</td>
      <td>Modify content, update, sync, adjust training parameters</td>
    </tr>
    <tr>
      <td>Can Manage</td>
      <td>Add or remove collaborators; deletion is Owner-only</td>
    </tr>
  </tbody>
</table>
...
- resourceType: Resource type (team/app/dataset/agentSkill/collection)
