...
There are many document libraries available online, such as Lark, Yuque, and others. Different AI Platform users may use different document libraries. AI Platform has built-in support for Lark and Yuque, but if you need to integrate other document libraries, follow this guide.

## Unified API Specification

To provide a unified interface for different document libraries, AI Platform defines a standard API specification with 4 endpoints. See the [API File Library endpoints](./api_dataset.en.mdx).
