...
description: How to connect DingTalk Dataset to FastGPT
---

FastGPT supports connecting DingTalk Dataset through a DingTalk internal enterprise app. When creating the dataset, enter `App Key`, `App Secret`, and `User ID`. After creation, open the dataset detail page, click `Add file`, and select the DingTalk workspace, online documents, or folders to import.
...
| AI Platform field | Where to get it in DingTalk                                                                                                                                                                                                                |
| ------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
...
- We recommend using a dedicated DingTalk member as the AI Platform sync account and granting it read-only access to the target workspace.
...
When a folder is selected, AI Platform recursively imports supported online documents under that folder.
