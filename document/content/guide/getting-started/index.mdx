...
想先上手，推荐阅读 [快速上手](/guide/getting-started/quick-start)；也可以直接打开云端试用：

- 中国大陆：<FastGPTLink campaign="docs_getting_started" content="cloud_entry_cn" site="cn">fastgpt.cn</FastGPTLink>
- 国际版：<FastGPTLink campaign="docs_getting_started" content="cloud_entry_io" site="io">fastgpt.io</FastGPTLink>
- 私有化部署：[Docker Compose 部署](/self-host/deploy/docker)

</Alert>

<Tabs groupId="getting-started-preview" items={['应用配置', '工作流', 'Skill', '团队管理']}>
  <Tab value="应用配置">![应用配置与调试预览](/imgs/image-30.png)</Tab>
  <Tab value="工作流">![可视化工作流编排](/imgs/image-45.png)</Tab>
  <Tab value="Skill">![Skill 编辑与沙盒调试](/imgs/image-46.png)</Tab>
  <Tab value="团队管理">![团队成员与权限管理](/imgs/image-47.png)</Tab>
</Tabs>
