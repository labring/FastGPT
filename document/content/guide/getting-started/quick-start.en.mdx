...
This article uses four complete use cases to help you quickly understand AI Platform's core app types and complete the basic setup from simple chats to complex task orchestration.

This page is suitable for first-time AI Platform users, as well as pre-sales, delivery, operations, legal, and administrative roles who want to quickly experience the platform's capabilities. After completing this page, you will build the following in order:
...
The focus of this case is not to have the AI randomly generate an email, but to consolidate the stable requirements of corporate email writing into the prompt, such as subject lines, salutations, body structure, action items, and risk reminders. For beginners, it also serves as a minimal closed loop for understanding AI Platform app configuration: first define the role, then constrain the output, and finally extend execution actions through tools.
...
1. **Create a Conversational Agent**
   ...
   ![AI Platform screenshot](/imgs/guide/getting-started/quick-start/image-01.png)
...
2. **Open the App Configuration Page**
   ...
   ![AI Platform screenshot](/imgs/guide/getting-started/quick-start/image-02.png)
...
3. **Select a Model**
   ...
   ![AI Platform screenshot](/imgs/guide/getting-started/quick-start/image-03.png)
...
4. **Write the Prompt**
   ...
   ![AI Platform screenshot](/imgs/guide/getting-started/quick-start/image-04.png)
...
5. **Add the Email Tool**
   ...
   ![AI Platform screenshot](/imgs/guide/getting-started/quick-start/image-05.png)

6. **Configure the Email Tool**

   Enter the tool configuration page and fill in the parameters related to the email service.

   ![AI Platform screenshot](/imgs/guide/getting-started/quick-start/image-06.png)

7. **Activate the Tool**

   Click "Settings" to enter the tool activation page, then click "Activate Tool".

   ![AI Platform screenshot](/imgs/guide/getting-started/quick-start/image-07.png)
...
8. **Fill in the Email SMTP Information**
   ...
   ![AI Platform screenshot](/imgs/guide/getting-started/quick-start/image-08.png)
...
9. **Set the Conversation Opening**
   ...
   ![AI Platform screenshot](/imgs/guide/getting-started/quick-start/image-09.png)
...
1. **Create a Dataset**
   ...
   ![AI Platform screenshot](/imgs/guide/getting-started/quick-start/image-12.png)

2. **Create a Text Collection**

   Click **New**, then select **Text Collection** to import local documents.

   ![AI Platform screenshot](/imgs/guide/getting-started/quick-start/image-13.png)
...
3. **Upload a Local File**
   ...
   ![AI Platform screenshot](/imgs/guide/getting-started/quick-start/image-14.png)

4. **Set Parsing Parameters**

   After entering the parameter settings page, choose the parsing method based on the file type.

   ![AI Platform screenshot](/imgs/guide/getting-started/quick-start/image-15.png)
...
5. **Preview Chunking Results**
   ...
   ![AI Platform screenshot](/imgs/guide/getting-started/quick-start/image-16.png)

6. **Wait for the Dataset to Be Ready**

   Once the data status changes to "Ready," apps can use the Dataset.

   ![AI Platform screenshot](/imgs/guide/getting-started/quick-start/image-17.png)
...
7. **Create and Link a Conversational Agent**
   ...
   ![AI Platform screenshot](/imgs/guide/getting-started/quick-start/image-18.png)
...
9. **Configure the Opening Message**
   ...
   ![AI Platform screenshot](/imgs/guide/getting-started/quick-start/image-19.png)
...
1. **Create a Workflow**
   ...
   ![AI Platform screenshot](/imgs/guide/getting-started/quick-start/image-21.png)

   After creation, enter the workflow editing page.

   ![AI Platform screenshot](/imgs/guide/getting-started/quick-start/image-22.png)
...
3. **Call the Dataset**
   ...
   ![AI Platform screenshot](/imgs/guide/getting-started/quick-start/image-24.png)

   ![AI Platform screenshot](/imgs/guide/getting-started/quick-start/image-25.png)
...
4. **Configure the Content Review Node**
   ...
   ![AI Platform screenshot](/imgs/guide/getting-started/quick-start/image-26.png)
...
5. **Test the Review Node**
   ...
   ![AI Platform screenshot](/imgs/guide/getting-started/quick-start/image-27.png)
...
6. **Hide Intermediate Output**
   ...
   ![AI Platform screenshot](/imgs/guide/getting-started/quick-start/image-28.png)
...
7. **Configure the Decision Node**
   ...
   ![AI Platform screenshot](/imgs/guide/getting-started/quick-start/image-29.png)
...
8. **Configure the Safe Branch**
   ...
   ![AI Platform screenshot](/imgs/guide/getting-started/quick-start/image-30.png)

   The output effect is as follows:

   ![AI Platform screenshot](/imgs/guide/getting-started/quick-start/image-31.png)
...
9. **Configure the Sensitive but Rewritable Branch**
   ...
   ![AI Platform screenshot](/imgs/guide/getting-started/quick-start/image-32.png)

   ![AI Platform screenshot](/imgs/guide/getting-started/quick-start/image-33.png)
   ...
   ![AI Platform screenshot](/imgs/guide/getting-started/quick-start/image-34.png)
...
1. **Create an Agent V2 App**
   ...
   ![AI Platform screenshot](/imgs/guide/getting-started/quick-start/image-36.png)
...
4. **Enable Virtual Machine Capability**
   ...
   ![AI Platform screenshot](/imgs/guide/getting-started/quick-start/image-37.png)
...
5. **Upload File and Test**
   ...
   ![AI Platform screenshot](/imgs/guide/getting-started/quick-start/image-38.png)

   During execution, you can see the task running in the virtual machine without affecting the local environment.

   ![AI Platform screenshot](/imgs/guide/getting-started/quick-start/image-39.png)
...
![AI Platform screenshot](/imgs/guide/getting-started/quick-start/image-40.png)
