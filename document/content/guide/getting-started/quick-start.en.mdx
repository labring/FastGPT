---
title: 'Quick Start'
description: 'Quickly experience FastGPT through four use cases: Conversational Agent, Dataset, Workflow, and Agent V2'
---

This article uses four complete use cases to help you quickly understand FastGPT's core app types and complete the basic setup from simple chats to complex task orchestration.
...
The focus of this case is not to have the AI randomly generate an email, but to consolidate the stable requirements of corporate email writing into the prompt, such as subject lines, salutations, body structure, action items, and risk reminders. For beginners, it also serves as a minimal closed loop for understanding FastGPT app configuration: first define the role, then constrain the output, and finally extend execution actions through tools.
...
1. **Create a Conversational Agent**
   ...
   ![Create a chat Agent named Email Writing Assistant in the workspace](/imgs/guide/getting-started/quick-start/image-01.png)
...
2. **Open the App Configuration Page**
   ...
   ![App config page with AI settings on the left and debug preview on the right](/imgs/guide/getting-started/quick-start/image-02.png)
...
3. **Select a Model**
   ...
   ![Select the chat model in AI configuration](/imgs/guide/getting-started/quick-start/image-03.png)
...
4. **Write the Prompt**
   ...
   ![Write the email Prompt into the system prompt module](/imgs/guide/getting-started/quick-start/image-04.png)
...
5. **Add the Email Tool**
   ...
   ![Add the Email sending tool to the chat Agent](/imgs/guide/getting-started/quick-start/image-05.png)

6. **Configure the Email Tool**

   Enter the tool configuration page and fill in the parameters related to the email service.

   ![Fill mail service parameters on the Email tool config page](/imgs/guide/getting-started/quick-start/image-06.png)

7. **Activate the Tool**

   Click "Settings" to enter the tool activation page, then click "Activate Tool".

   ![Open the tool activation page and activate the Email tool](/imgs/guide/getting-started/quick-start/image-07.png)
...
8. **Fill in the Email SMTP Information**
   ...
   ![Enter QQ Mail SMTP server settings and authorization code](/imgs/guide/getting-started/quick-start/image-08.png)
...
9. **Set the Conversation Opening**
   ...
   ![Configure the chat greeting and preview it on the right](/imgs/guide/getting-started/quick-start/image-09.png)
...
10. **Validate the Result**
    ...
    ![Enter an email request in debug preview and generate a draft](/imgs/guide/getting-started/quick-start/image-10.png)
    ...
    ![Assistant asks for recipient and purpose when information is missing](/imgs/guide/getting-started/quick-start/image-11.png)
...
1. **Create a Dataset**
   ...
   ![Create a Dataset named Civil Code Q&A Assistant](/imgs/guide/getting-started/quick-start/image-12.png)

2. **Create a Text Collection**

   Click **New**, then select **Text Collection** to import local documents.

   ![Create a text collection for importing local documents](/imgs/guide/getting-started/quick-start/image-13.png)
...
3. **Upload a Local File**
   ...
   ![Upload a Civil Code sample file to the Dataset](/imgs/guide/getting-started/quick-start/image-14.png)

4. **Set Parsing Parameters**

   After entering the parameter settings page, choose the parsing method based on the file type.

   ![Configure file parsing and chunking parameters](/imgs/guide/getting-started/quick-start/image-15.png)
...
5. **Preview Chunking Results**
   ...
   ![Preview Dataset chunks for completeness and readability](/imgs/guide/getting-started/quick-start/image-16.png)

6. **Wait for the Dataset to Be Ready**

   Once the data status changes to "Ready," apps can use the Dataset.

   ![Dataset status shows Ready](/imgs/guide/getting-started/quick-start/image-17.png)
...
7. **Create and Link a Conversational Agent**
   ...
   ![Create a chat Agent and link the Civil Code Dataset](/imgs/guide/getting-started/quick-start/image-18.png)
...
9. **Configure the Opening Message**
   ...
   ![Configure a greeting with clickable sample questions](/imgs/guide/getting-started/quick-start/image-19.png)
...
10. **Verify Q&A Performance**
    ...
    ![Verify Civil Code answers include citations and a disclaimer](/imgs/guide/getting-started/quick-start/image-20.png)
...
1. **Create a Workflow**
   ...
   ![Create a workflow named Content Review and Auto Rewrite](/imgs/guide/getting-started/quick-start/image-21.png)

   After creation, enter the workflow editing page.

   ![Open the visual workflow editor](/imgs/guide/getting-started/quick-start/image-22.png)

   The complete workflow diagram for this case is as follows:

   ![Content compliance review workflow overview](/imgs/guide/getting-started/quick-start/image-23.png)
...
3. **Call the Dataset**
   ...
   ![Add a Dataset search node and select the compliance rule Dataset](/imgs/guide/getting-started/quick-start/image-24.png)

   ![Configure Dataset search inputs and citation limits](/imgs/guide/getting-started/quick-start/image-25.png)
...
4. **Configure the Content Review Node**
   ...
   ![Configure the content review AI node classification Prompt](/imgs/guide/getting-started/quick-start/image-26.png)
...
5. **Test the Review Node**
   ...
   ![Run the content review node alone to test classification](/imgs/guide/getting-started/quick-start/image-27.png)
...
6. **Hide Intermediate Output**
   ...
   ![Hide intermediate output from the content review node](/imgs/guide/getting-started/quick-start/image-28.png)
...
7. **Configure the Decision Node**
   ...
   ![Configure a judge node to branch by safe, rewritable, and blocked](/imgs/guide/getting-started/quick-start/image-29.png)
...
8. **Configure the Safe Branch**
   ...
   ![Configure the safe branch to output the original text](/imgs/guide/getting-started/quick-start/image-30.png)

   The output effect is as follows:

   ![Output of the safe branch after approval](/imgs/guide/getting-started/quick-start/image-31.png)
...
9. **Configure the Sensitive but Rewritable Branch**
   ...
   ![Configure the rewrite node on the rewritable branch](/imgs/guide/getting-started/quick-start/image-32.png)

   ![Add a user confirmation node on the rewritable branch](/imgs/guide/getting-started/quick-start/image-33.png)
   ...
   ![Connect accept, rewrite again, or discard user choices](/imgs/guide/getting-started/quick-start/image-34.png)
...
11. **Verify the Complete Workflow**
    ...
    ![Validate the full safe, rewritable, and blocked paths](/imgs/guide/getting-started/quick-start/image-35.png)
...
1. **Create an Agent V2 App**
   ...
   ![Create chat Agent V2 named Intelligent Data Analysis Agent](/imgs/guide/getting-started/quick-start/image-36.png)
...
4. **Enable Virtual Machine Capability**
   ...
   ![Enable the Agent V2 virtual machine capability](/imgs/guide/getting-started/quick-start/image-37.png)
...
5. **Upload File and Test**
   ...
   ![Upload sales data and view the task breakdown after asking a question](/imgs/guide/getting-started/quick-start/image-38.png)

   During execution, you can see the task running in the virtual machine without affecting the local environment.

   ![Analysis tasks running inside the virtual machine](/imgs/guide/getting-started/quick-start/image-39.png)
...
![Analysis result with plan, overview, findings, and recommendations](/imgs/guide/getting-started/quick-start/image-40.png)
