...
To simplify integration with **external member systems**, AI Platform provides a set of **standard interfaces** for connecting to external systems, along with a FastGPT-SSO-Service image that serves as an **adapter**.
...
2.  Create an internal app for AI Platform:
...
AI Platform provides the following standard interfaces:
...
Returns a redirect login URL. AI Platform will automatically redirect to this URL. The redirect_uri is automatically appended to the URL query string.
...
1. Self-development: Build according to the standard interfaces provided by AI Platform, then enter the deployed service address into fastgpt-pro.
...
2. Custom development by the AI Platform team:
