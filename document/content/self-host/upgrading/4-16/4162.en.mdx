...
6. Document parsing now supports DOC, WPS, DOCM, PPT, PPS, POT, PPTM, PPSX, PPSM, XLS, XLSM, XLSB, ODT, ODS, ODP, RTF, and EPUB files. These newly supported formats currently parse text only; embedded images are not extracted or parsed.
