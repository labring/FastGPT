...
| `AGENT_SANDBOX_STORAGE_SIZE_GB`       | `1`     | Agent Sandbox storage size in GB. Used as the Sealos Devbox storage limit and for new OpenSandbox PVCs in Kubernetes mode. |
