...
6. 文档解析新增支持 DOC、WPS、DOCM、PPT、PPS、POT、PPTM、PPSX、PPSM、XLS、XLSM、XLSB、ODT、ODS、ODP、RTF 和 EPUB 格式。解析器识别到的内嵌图片会提取并上传到对象存储，在解析结果中保留图片引用；未识别的图片形态仍会回退为可解析的文本内容。
