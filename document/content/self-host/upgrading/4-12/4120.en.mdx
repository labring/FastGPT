...
- Update AI Platform image tag: v4.12.0
- Update AI Platform commercial edition image tag: v4.12.0
...
Update the AI Platform commercial edition (fastgpt-pro) environment variables:
