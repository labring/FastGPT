...
6. Code Sandbox now logs full exceptions when Worker response parsing or handling fails and returns the error type and cause to callers for easier troubleshooting.
