...
1. 修改 AI Platform 环境变量：SANDBOX_URL 和 SANDBOX_TOKEN，改名成 CODE_SANDBOX_URL 和 CODE_SANDBOX_TOKEN：
...
- 更新 AI Platform 镜像 tag: v4.14.9.5
- 更新 AI Platform 商业版镜像 tag: v4.14.9.5
