...
- Update fastgpt-app (AI Platform main service) image tag to: v4.14.11
...
4. Unified S3 file uploads, with support for proxying S3 uploads and access through AI Platform to reduce pre-signed URL configuration issues.
