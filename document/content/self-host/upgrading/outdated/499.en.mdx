...
Pro edition users can contact the AI Platform team for a license replacement plan. After replacement, you can upgrade the system directly — the admin panel will prompt you to enter the new license.

### 3. Update Image Tags

- Update AI Platform image tag: v4.9.9
- Update AI Platform Pro image tag: v4.9.9
