...
Pro Edition no longer supports configuring the MCP proxy URL in the Admin panel. Configure `SSE_MCP_SERVER_PROXY_ENDPOINT=<public fastgpt-mcp-server URL>` in the FastGPT container environment variables instead.
