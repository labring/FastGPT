...
3. Improved - Query completion. Query completion is now built into the Knowledge Base Search module, enabling both "reference resolution" and "query expansion" in a single pass. See [Knowledge Base Search Introduction](../../../introduction/guide/dashboard/workflow/dataset_search.en.mdx) for details.
