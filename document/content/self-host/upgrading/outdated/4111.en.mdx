...
- Update AI Platform image tag: v4.11.1-fix2
- Update AI Platform commercial edition image tag: v4.11.1-fix
...
4. Moved model preset configurations to the AI Platform Plugin project.
