...
- Update AI Platform image tag: v4.9.0
- Update AI Platform Pro image tag: v4.9.0
...
Modify the environment variables for the AI Platform container in the yml file:
