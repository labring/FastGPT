...
- Update AI Platform image tag: v4.9.2
- Update AI Platform Pro image tag: v4.9.2
...
5. Team member management overhaul: extracted mainstream IM SSO (WeCom, Lark, DingTalk) and added support for connecting to AI Platform via custom SSO. Also improved member sync with external systems.
...
4. AI Platform now properly displays AI Proxy channel names even when channels are not built in.
