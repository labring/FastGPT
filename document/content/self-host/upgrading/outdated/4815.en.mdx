...
1. New - API Knowledge Base. See [API Knowledge Base Introduction](../../../introduction/guide/knowledge_base/api_dataset.en.mdx). The external file library will be deprecated.
