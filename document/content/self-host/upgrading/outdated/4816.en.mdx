...
1. New - SearXNG search plugin. [View tutorial](../../../introduction/guide/plugins/searxng_plugin_guide.en.mdx)
...
5. New - Commercial edition supports DingTalk SSO login configuration. [View tutorial](../../../introduction/guide/admin/sso.en.mdx#钉钉)
6. New - Commercial edition supports Lark and Yuque Knowledge Base import. [View tutorial](../../../introduction/guide/knowledge_base/lark_dataset.en.mdx)
