...
- Update the fastgpt-app (AI Platform main service) image tag to v4.15.0-beta4.
- Update the fastgpt-pro (AI Platform commercial edition) image tag to v4.15.0-beta4.
