...
- Update the fastgpt-app (AI Platform main service) image tag to v4.15.1.
- Update the fastgpt-pro (AI Platform commercial edition) image tag to v4.15.1.
...
6. Fixed repeated shallow route updates in the embedded AI Platform Marketplace when filters did not change, which could keep the top progress bar loading.
