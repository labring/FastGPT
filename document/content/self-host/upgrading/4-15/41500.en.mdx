...
- Update fastgpt-app (AI Platform main service) image tag: v4.15.0
- Update fastgpt-pro (AI Platform commercial edition) image tag: v4.15.0
...
5. The commercial edition now supports local direct-connect debugging for AI Platform plugins.
