...
| Variable                                     | Default                  | Description                                                                                                                                                                                                        |
| -------------------------------------------- | ------------------------ | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| `AGENT_SANDBOX_PROVIDER`                     | Empty                    | Agent sandbox provider. Supported values are `sealosdevbox`, `opensandbox`, and `e2b`. The feature is enabled only when this value and the matching provider credentials, runtime image, and proxy config are set. |
