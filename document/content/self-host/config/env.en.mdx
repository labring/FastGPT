...
| `AGENT_SANDBOX_APT_MIRROR`                       | Empty                    | apt mirror for Ubuntu Agent sandboxes. Works with OpenSandbox and Sealos Devbox; the image's original official sources remain available if configuration fails.                                                                                                                |
