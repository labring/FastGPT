...
| `AGENT_SANDBOX_OPENSANDBOX_VOLUME_NAME_PREFIX`   | `fastgpt-session`        | Prefix used by the FastGPT app when generating persistent OpenSandbox volume `claimName` values.                                                                                                                                                                               |
