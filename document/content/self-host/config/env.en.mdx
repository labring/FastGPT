...
| `AGENT_SANDBOX_ARCHIVE_MAX_SIZE` | `10` | Maximum Agent sandbox archive and Skill package size, in MB. Used for archive, upload, extraction, download, and sandbox packaging checks. |
