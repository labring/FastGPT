...
| `FILE_URL_EXPIRED_HOURS`  | `1`                         | Default lifetime of file access short links, in hours. Fractions are allowed (`0.5` means 30 minutes). It applies to dataset image/file and chat (including tool-generated) file preview and download links; links with their own long lifetime, such as exports or plugin uploads, are unaffected. |
