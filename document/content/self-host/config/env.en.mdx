...
| Variable                                         | Default                  | Description                                                                                                                                                                                                                                                                     |
| ------------------------------------------------ | ------------------------ | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `AGENT_SANDBOX_PROVIDER`                         | Empty                    | Agent sandbox provider. Supported values are `sealosdevbox` and `opensandbox`. Empty disables sandbox. Once set, the matching provider required env vars, `AGENT_SANDBOX_PROXY_SECRET`, and `AGENT_SANDBOX_PROXY_URL` must also be configured, otherwise service startup fails. |
