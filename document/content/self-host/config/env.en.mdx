...
| Variable                                         | Default                  | Description                                                                                                                                                                                                                                        |
| ------------------------------------------------ | ------------------------ | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `AGENT_SANDBOX_PROVIDER`                         | Empty                    | Agent Sandbox provider. Supported values are `sealosdevbox` and `opensandbox`. Empty disables Sandbox. Once set, the matching provider variables and all three proxy variables are required for startup.                                           |
...
| `AGENT_SANDBOX_PREVIEW_PROXY_URL`                | Empty                    | Browser-accessible HTTP(S) URL for Sandbox file previews. Required when Agent Sandbox is enabled. Use an origin separate from the FastGPT application to keep user-generated HTML scripts outside the application's same-origin security boundary. |
