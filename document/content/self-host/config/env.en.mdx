...
| `PARSE_FILE_WORKER_MEMORY_LIMIT_MB`    | `512`       | V8 old-generation memory limit for each file parsing worker, in MB. Minimum value is `128`.                                                                                   |
| `XLSX_PARSE_MAX_ROWS`                  | `100000`    | Maximum rows allowed in one XLSX worksheet. Minimum value is `1`.                                                                                                             |
| `XLSX_PARSE_MAX_COLUMNS`               | `1000`      | Maximum columns allowed in one XLSX worksheet. Minimum value is `1`.                                                                                                          |
