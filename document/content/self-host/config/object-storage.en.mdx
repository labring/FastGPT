...
This guide covers environment variable configuration for object storage providers supported by AI Platform, including self-hosted MinIO, AWS S3, Cloudflare R2, Alibaba Cloud OSS, and Tencent Cloud COS.
...
- Uploads always go through the AI Platform backend proxy.
- External download URLs are always AI Platform short links. AI Platform no longer returns object storage presigned URLs directly.
