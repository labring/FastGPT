...
- **Distributed Tracing**: Track the complete call chain of user requests across AI Platform services
...
1. Update AI Platform environment variables
...
SigNoz monitoring is very disk-intensive. First, avoid storing AI Platform debug logs in SigNoz. Also consider setting the log retention period to 7 days. If SigNoz data stops growing while memory keeps increasing, the disk is full — expand capacity.
