...
| `probe.testedAt`  | string | ISO 8601 timestamp when probe finished (e.g., `2026-09-23T01:45:15.000Z`) |
...
```json
{
  ...
  "probe": {
    ...
    "testedAt": "2026-09-23T01:45:15.000Z"
  }
}
```
...
```json
{
  ...
  "probe": {
    "attempts": 1,
    "latencyMs": 1630,
    "testedAt": "2026-09-23T01:50:15.000Z"
  }
}
```
