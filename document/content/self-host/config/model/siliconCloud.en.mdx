...
If you want to quickly try open source models or get started with AI Platform without applying for API keys from multiple providers, SiliconCloud is a great option for a fast start.

If you plan to self-host models and AI Platform in the future, you can use SiliconCloud for initial testing and validation, then proceed with hardware procurement later — reducing POC time and cost.
