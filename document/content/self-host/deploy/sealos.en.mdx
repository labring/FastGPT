...
AI Platform uses the one-api project to manage model pools, supporting OpenAI, Azure, mainstream domestic models, and local models.
...
After clicking details, you'll see the AI Platform deployment management page. Click the link in the external access address to open the AI Platform service.
...
AI Platform Commercial Edition includes 2 apps (fastgpt, fastgpt-plus) and 2 databases. When using multiple API keys, install OneAPI (1 app and 1 database), totaling 3 apps and 3 databases.
...
In Sealos, open **App Launchpad** to see deployed AI Platform apps, and open **Database** to see corresponding databases.

In **App Launchpad**, select AI Platform, click **Change**, and you'll see environment variables and config files.

![](../../../public/imgs/fastgptonsealos1.png)

<Alert icon="🤖" context="success">
  On Sealos, AI Platform runs 1 service and 2 databases. When pausing or deleting, handle the databases
