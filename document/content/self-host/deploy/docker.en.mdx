...
4. Port 3003 (FastGPT SSE MCP server service; you can leave this port closed if you don't need it.)
...
Starting with V4.17.0, **you must deploy or connect to AI Proxy** and set these environment variables in the FastGPT container:
