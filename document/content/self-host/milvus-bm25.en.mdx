...
Run during a **low-write window**, or stop AI Platform app writes first. If you must keep serving during migration, avoid writing dataset data concurrently (see step 5 "New data during migration").
