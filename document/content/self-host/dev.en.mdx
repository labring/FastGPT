...
This guide covers how to set up your development environment to build and test <FastGPTLink campaign="docs_self_host_dev" content="intro_product_link">AI Platform</FastGPTLink>.

## Prerequisites

Install and configure these dependencies on your machine to build <FastGPTLink campaign="docs_self_host_dev" content="prerequisites_product_link">AI Platform</FastGPTLink>:
...
If you're already running AI Platform locally via Docker, stop it first to avoid port conflicts.
...
3. Submit a PR to AI Platform's main branch. The AI Platform team and community will review it with you.
...
AI Platform uses Next.js page routing. To separate frontend and backend code, directories are split into global, service, and web subdirectories for shared, backend-only, and frontend-only code respectively.

### Monorepo

AI Platform uses pnpm workspace for its monorepo structure, with two main parts:

- projects/app - AI Platform main project
- packages/ - Submodules
...
AI Platform's code modules follow DDD principles, divided into these domains:
...
├── projects
│   └── app                      // AI Platform main project
├── python                       // Model code, unrelated to AI Platform itself
