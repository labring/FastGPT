...
In FastGPT, go to Admin -> Model provider -> Model configuration -> Add model. Make sure the model ID matches the model name in OneAPI. See details [here](../config/model/intro.en.mdx).
...
In FastGPT, go to Admin -> Model provider -> Model configuration -> Add model. Make sure the model ID matches the model name in OneAPI.
