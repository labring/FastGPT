...
AI Platform lets you use your own OpenAI API KEY to quickly call OpenAI APIs. It currently integrates GPT-3.5, GPT-4, and embedding models for building Datasets. However, for data security reasons, you may not want to send all data to cloud-based LLMs.

So how do you connect a private model to AI Platform? This guide walks through integrating Tsinghua's ChatGLM2 as an example.
