...
FastGPT lets you use your own OpenAI API KEY to quickly call OpenAI APIs. It currently integrates GPT-3.5, GPT-4, and embedding models for building Datasets. However, for data security reasons, you may not want to send all data to cloud-based LLMs.
