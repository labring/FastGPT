...
description: Integrating the bge-rerank Rerank model with FastGPT
---
...
1. Open the AI Platform model configuration and add a new Rerank model.
...
The custom request token in AI Platform does not match the ACCESS_TOKEN environment variable.
