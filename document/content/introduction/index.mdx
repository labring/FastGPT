...
|                       |                                   |
| --------------------- | --------------------------------- |
| ![](../../public/imgs/intro/image1.png) | ![](../../public/imgs/intro/image2.png) |
...
![](../../public/imgs/intro/image5.png)

## 4. 工作流编排
基于 Flow 模块的工作流编排，可以帮助你设计更加复杂的问答流程。例如查询数据库、查询库存、预约实验室等。

![](../../public/imgs/intro/image6.png)

## 5. 强大的 API 集成
FastGPT 完全对齐 OpenAI 官方接口，支持一键接入企业微信、公众号、飞书、钉钉等平台，让 AI 能力轻松融入您的业务场景。

![](../../public/imgs/intro/image7.png)
