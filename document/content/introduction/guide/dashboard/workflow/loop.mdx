...
![批量运行节点](../../../../../public/imgs/fastgpt-loop-node.png)
...
![循环体配置](../../../../../public/imgs/fastgpt-loop-node-config.webp)
...
1. 准备输入数组
   ...
   ![准备输入数组](../../../../../public/imgs/fastgpt-loop-node-example-1.png)
...
2. 配置批量运行节点
   ...
   ![配置批量运行节点](../../../../../public/imgs/fastgpt-loop-node-example-2.png)
...
![运行流程](../../../../../public/imgs/fastgpt-loop-node-example-3.png)
...
1. 文本预处理与分段
   ...
   ![文本预处理与分段](../../../../../public/imgs/fastgpt-loop-node-example-4.png)
...
2. 配置批量运行节点
   ...
   ![配置批量运行节点](../../../../../public/imgs/fastgpt-loop-node-example-5.png)
