...
![Batch Processing node](../../../../../public/imgs/fastgpt-loop-node.png)
...
![Loop body configuration](../../../../../public/imgs/fastgpt-loop-node-config.webp)
...
1. Prepare the input array
   ...
   ![Prepare input array](../../../../../public/imgs/fastgpt-loop-node-example-1.png)
...
2. Configure the Batch Processing node
   ...
   ![Configure Batch Processing node](../../../../../public/imgs/fastgpt-loop-node-example-2.png)
...
![Execution flow](../../../../../public/imgs/fastgpt-loop-node-example-3.png)
...
1. Text preprocessing and segmentation
   ...
   ![Text preprocessing and segmentation](../../../../../public/imgs/fastgpt-loop-node-example-4.png)
...
2. Configure the Batch Processing node
   ...
   ![Configure Batch Processing node](../../../../../public/imgs/fastgpt-loop-node-example-5.png)
