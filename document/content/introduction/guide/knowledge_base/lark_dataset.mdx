...
| | |
| --- | --- |
| ![alt text](../../../../public/imgs/image-39.png) | ![alt text](../../../../public/imgs/image-40.png) |
...
![alt text](../../../../public/imgs/image-41.png)

## 3. 获取 appId 和 appSecret

![alt text](../../../../public/imgs/image-42.png)
...
![alt text](../../../../public/imgs/image-44.png)

## 6. 创建知识库

根据 3 和 5 获取到的 3 个参数，创建知识库，选择飞书文件库类型，然后填入对应的参数，点击创建。

![alt text](../../../../public/imgs/image-39.png)
